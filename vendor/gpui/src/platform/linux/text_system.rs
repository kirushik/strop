        ...
        let image = self
            ...
            .get_image(
                ...
                CacheKey::new(
                    ...
                    // We bundle real faces for every weight and never ask
                    // cosmic-text for synthetic bold (get_font is always
                    // called with Weight::NORMAL), so NORMAL matches here.
            ...
            let mut image = self
                ...
                .get_image(
                    ...
                    CacheKey::new(
                        ...
                        (params.font_size * params.scale_factor).into(),
                        (subpixel_shift.x, subpixel_shift.y.trunc()),
                        // Same rationale as raster_bounds: no synthetic bold.
                        cosmic_text::Weight::NORMAL,
                        cosmic_text::CacheKeyFlags::empty(),
                    )
                    .0,
