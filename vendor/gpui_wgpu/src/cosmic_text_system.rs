//! VENDORED by Strop from zed-industries/zed @ 992f395c3d696d96946302cd0a8721a72954ba39
//! with ONE local patch in `render_glyph_image` (search for "STROP PATCH"):
//! a fresh swash ScaleContext per glyph rasterization, working around the
//! scale-change glyph corruption documented in docs/UPSTREAM-gpui-scale-bug.md.
//! Delete this vendored crate and the [patch] in the workspace Cargo.toml
